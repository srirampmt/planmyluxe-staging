...
export default async function DestinationPage({ params }: PageProps) {
  ...
  if (parentCountrySlug && parentCountrySlug.toLowerCase() !== slug.toLowerCase()) {
    breadcrumbs.push({
      name: slugToName(parentCountrySlug),
      slug: `/destinations/${parentCountrySlug}`,
    });
  }
  if (parentRegionSlug && parentRegionSlug.toLowerCase() !== slug.toLowerCase() && parentRegionSlug.toLowerCase() !== parentCountrySlug.toLowerCase()) {
    breadcrumbs.push({
      name: slugToName(parentRegionSlug),
      slug: `/destinations/${parentRegionSlug}`,
    });
  }
