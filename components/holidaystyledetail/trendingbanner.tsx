...
export default function trendingbanner({
  ...
  const card_image = add_card_image || "";
  const subtitle = add_subtitle || "";
    ...
    <div className="max-w-7xl mx-auto px-[16px] sm:px-[16px] md:px-[16px] lg:px-0 py-0 md:py-10 pb-6 md:mb-0 font-['Montserrat']">
      <div className="rounded-[8px] overflow-hidden relative h-[180px] md:h-[160px] lg:h-[160px]">
        ...
        <div className="hidden min-[1000px]:flex w-full h-full items-center justify-between absolute inset-0 z-10">
          ...
          />
          <a href={link} className="absolute right-8 bottom-8 bg-white text-pml-primary px-4 py-2 rounded-[8px] text-[14px] font-medium hover:bg-[#f3f3f3] w-auto text-center border-[2px] border-transparent hover:border-pml-primary" >
            DOWNLOAD OUR DEALS!
          </a>
        </div>
        ...
        <div className="block max-[600px]:hidden w-full h-full bg-pml-primary rounded-[8px] border-4 border-white min-[1000px]:hidden p-4 flex flex-row items-center justify-start  gap-4">
          ...
          <a href={link} className="mt-0 md:mt-4 bg-white text-pml-primary px-2 md:px-4 py-2 rounded-[8px] text-[11px] sm:text-sm font-medium hover:bg-[#f3f3f3] w-full sm:w-auto text-center border-[2px] border-transparent hover:border-pml-primary sm:mt-0 sm:ml-auto sm:self-end">
            DOWNLOAD&nbsp;OUR&nbsp;DEALS!
          </a>
        </div>
        ...
        <div className="absolute block min-[600px]:hidden inset-0 flex flex-col justify-center items-center gap-3 px-6 md:px-12 sm:flex-row sm:justify-between sm:items-end sm:gap-5 sm:pb-6 md:pb-10 bg-pml-primary">
          ...
          <a href={link} className="mt-0 md:mt-4 bg-white text-pml-primary px-2 md:px-4 py-2 rounded-[8px] text-[14px] font-medium hover:bg-[#f3f3f3] w-full sm:w-auto text-center border-[2px] border-transparent hover:border-pml-primary sm:mt-0 sm:ml-auto sm:self-end" >
            DOWNLOAD OUR DEALS!
          </a>
        </div>
      </div>                                                 
