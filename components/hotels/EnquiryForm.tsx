...
export default function EnquiryForm({
  ...
  onClose,
  showQuickHelp = true,
  containerClassName = "bg-white rounded-[4px] p-4",
  messageRows = 4,
}: {
          ...
          <div className="space-y-4">
            ...
            <div>
              <textarea
                ...
                rows={messageRows}
                className={`w-full bg-white px-3 py-3 text-[14px] outline-none border resize-y overflow-y-auto ${getBorderClass(
                  "message"
                )}`}
